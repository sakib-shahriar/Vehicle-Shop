...
public class Application {
    ...
    public void addVehicle() {
        ...
        for (Map.Entry<Integer, VehicleOption<? extends Vehicle>> entry : this.vehicleTypes.entrySet()) {
            System.out.println(entry.getKey() + ". " + entry.getValue().getName());
        }
        VehicleOption<? extends Vehicle> vehicleOption = (VehicleOption<? extends Vehicle>) InputUtil.getObjectByInputForVehicleType(this.vehicleTypes);
        ...
        if(vehicle instanceof SportsVehicle) {
            int numberOfVisitor = this.getNumberOfVisitor();
            this.setNumberOfVisitor(numberOfVisitor + 20);
        }
    ...
    public void removeVehicle() {
        ...
        int choice = InputUtil.takeMenuOptionInput(this.vehicles.size());
    ...
    public void runApplication() {
        while (true) {
            ...
            int choice = InputUtil.takeMenuOptionInput(5);
            switch (choice) {
                case 1:
                    this.addVehicle();
                    break;
